...
public class UserServiceImpl implements UserDetailsService, UserService, RoleService {
...
//roleDao.save(role);
        System.out.println(roleDao.findByName("USER").getDescription());


        newUser.getRoles().add(roleDao.findByName("USER"));
